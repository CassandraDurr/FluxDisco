"""Run FluxDisco ablation experiments with no imposed stoichiometry from the paper."""
...
configurations = {
    ...
    "lotka-volterra": {
        ...
        "num_fluxes": 2,  # Decrease to 2
        "system_structure": {"x": [1, 0], "y": [0, 1]},  # Identity matrix
        "grammar": {
